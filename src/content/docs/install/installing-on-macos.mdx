...
description: How to install IW4x on MacOS
sidebar:
  order: 4
tableOfContents:
  maxHeadingLevel: 5
...
IW4x on MacOS has a similar installation process as [Linux](/install/installing-on-linux), but with the additional complexity that Wine must often be wrapped within a managed runtime such as **[CrossOver](https://www.codeweavers.com/crossover)** or **[WineSkin](https://sourceforge.net/projects/wineskin/)**.  
