...
lastUpdated: 2025-22-09
next:
  label: Manual Installation on Windows
---

import { FileTree, LinkButton, Tabs, TabItem, Steps } from '@astrojs/starlight/components';

import Video from '../../../components/Video.astro';
import find_directory from "../../../assets/img/install/find_install_folder.mp4";
import download_launcher from "../../../assets/img/install/download_launcher.mp4";
...
Once you've located the Modern Warfare 2 game directory, you are read install IW4x.  
...
1. Get the launcher from [GitHub](https://github.com/iw4x/launcher)
    ...
    <LinkButton href="https://github.com/iw4x/launcher/releases/latest/download/iw4x-launcher.exe" variant="primary" icon="seti:windows" iconPlacement="start">**Download for Windows**</LinkButton>
    <LinkButton href="https://github.com/iw4x/launcher/releases/latest/download/iw4x-launcher-x86_64-unknown-linux-gnu.tar.gz" variant="primary" icon="linux" iconPlacement="start">**Download for Linux**</LinkButton>
...
![Windows rotected your PC](../../../assets/img/install/windows_protected_your_pc.png)
...
These are configuration values you can adjust to suit your preferences (more details about each option on [GitHub](https://github.com/iw4x/launcher#%EF%B8%8F-command-line-arguments)).  
...
For example, if you want to play offline against bots using the [Bot Warfare Mod](https://github.com/ineedbots/iw4_bot_warfare), you could set `"args"` like this:
